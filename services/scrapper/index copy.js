...
var _clave = configs.SCRAPPER.clave;
var _usuario = configs.SCRAPPER.usuario;
var _pass = configs.SCRAPPER.pass;  
...
app.get('/login/:user/:password',   async(req,res) => {
    try
    {
        ...
        mensaje = {"code":null,"message":null};
...
app.get('/jobs',async (req,res) => {
   ...
   { 
    ...
    if (information.jobs.length > 0) 
    {
        ...
        if (req.query.speciality){ answer = information.jobs.filter( (job) => { return job.hasSpeciality(req.query.speciality) });}
